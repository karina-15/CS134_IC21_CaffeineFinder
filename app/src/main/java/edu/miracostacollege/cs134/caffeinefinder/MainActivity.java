...
//TODO: (3) Implement the OnMapReadyCallback interface for Google Maps
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // Load a Google Map into out mapsFragment
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add normal markers for each of the caffeine locations
        for (Location location : allLocationsList) {
            map.addMarker(new MarkerOptions()
                    .title(location.getName())
                    .position(new LatLng(location.getLatitude(), location.getLongitude())));
                    // can add coffee bean / coffee mug as icon
        }
    }



    // TODO: (6) Create a viewLocationsDetails(View v) method to create a new Intent to the
    // TODO: CaffeineDetailsActivity class, sending it the selectedLocation the user picked
    // TODO: from the locationsListView
}
